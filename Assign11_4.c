...
///////////////////////////////////////////////////////////////////////////////////////////////
//
//  Function Name  : RangeDisplayOdd
//  Description   : Used to display odd numbers in the given range
...
void RangeDisplayOdd(int iStart, int iEnd)
{
    int iCnt = 0;
...
int main()
{
    ...
    RangeDisplayOdd(iValue1, iValue2);
